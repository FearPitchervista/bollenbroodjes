...
<nav class="navbar">
        <div class="navbar__container">
            ...
            <ul class="navbar__menu">
                <li class="navbar__item">
                    <a href="home2.php" class="navbar__links">Home</a>
                </li>
                <li class="navbar__item">
                    <a href="DIT MOET VERANDEREN" class="navbar__links">Recepten</a>
                <li class="navbar__item">
                    <a href="DIT MOET VERANDEREN" class="navbar__links">Voorraad</a>
                </li>
                </li>
    ...
    <h2>Welkom op de homepagina voor alle medewerkers</h2>
